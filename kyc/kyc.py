...
def kyc2():
    ...
    if  _Aadhar and _Name_of_aadhar and _date_of_birth and _gender and  request.method =='POST':
        ...
        id= monq.db.kyc_institude.insert_one({'aadhar':_Aadhar,'name_addhar':_Name_of_aadhar , 'birth':_date_of_birth,'gender':_gender })
...
def kyc3():
    ...
    if  _Aadhar and _Name_of_aadhar and _date_of_birth and _gender and  request.method =='POST':
        ...
        id= monq.db.kyc_institude_head.insert_one({'aadhar':_Aadhar,'name_addhar':_Name_of_aadhar , 'birth':_date_of_birth,'gender':_gender })
